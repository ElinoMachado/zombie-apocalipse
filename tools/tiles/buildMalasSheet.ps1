# Recorta 8 malas (4×2) — grelha fixa + trim por célula + fundo preto transparente.
Add-Type -AssemblyName System.Drawing

$root = Split-Path (Split-Path $PSScriptRoot -Parent) -Parent
$propsDir = Join-Path $root "public/assets/props"
$src = Join-Path $propsDir "malas_source.png"
$out = Join-Path $propsDir "malas_sheet.png"
$meta = Join-Path $propsDir "malas_sheet.meta.json"
...
Write-Output "malas_sheet.png ${outW}x${outH} frame ${maxW}x${maxH} (${cols}x${rows}, grid trim)"
