# Recorta 8 mochilas (2×4) — grelha fixa + trim por célula + fundo preto transparente.
Add-Type -AssemblyName System.Drawing

$root = Split-Path (Split-Path $PSScriptRoot -Parent) -Parent
$propsDir = Join-Path $root "public/assets/props"
$src = Join-Path $propsDir "backpacks_source.png"
$out = Join-Path $propsDir "backpacks_sheet.png"
$meta = Join-Path $propsDir "backpacks_sheet.meta.json"
...
Write-Output "backpacks_sheet.png ${outW}x${outH} frame ${maxW}x${maxH} (${cols}x${rows}, grid trim)"
